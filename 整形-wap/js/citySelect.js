 ...
 * @LastEditors: zhuhao
 * @LastEditTime: 2020-08-05 16:11:02
 */
/**
...
$(function () {
    ...
    $('.citySelect').on('click', function () {
        ...
        $('.dropProv').toggle();
        if ($('.cityName').attr('data')) {

            $('.dropCity').css("display", "block");
            $('.dropCityUl').empty();

            for (let j = 0; j < arr2[$('.cityName').attr('data')].length; j++) {
                $('.dropCityUl').append("<li class='dropCityLi'>" + arr2[$('.cityName').attr('data')][j] + "</li>");
                if (arr2[$('.cityName').attr('data')][j] == $('.cityName').text()) {
                    $($('.dropCityLi')[j]).css("background-color", "#fff2f4")
                }
                $('.dropCityLi').on("click", function () {
                    //console.log($(this).text());
                    $('.dropCityLi').css("background-color", "#fff")
                    $('.cityName').text($(this).text());
                    $('.dropDown div').css("display", "none");
                    $('.mask').hide();
                    $('.drop_tit').hide();
                    $('.citySelect').addClass('activeCity')
